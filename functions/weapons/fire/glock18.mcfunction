...
# anims
playanimation @s[tag=silencer] animation.glock18.fire.silenced fire 0 "!q.is_item_name_any('slot.weapon.mainhand', 0, 'trenbankai:glock18')"
playanimation @s[tag=!silencer] animation.glock18.fire fire 0 "!q.is_item_name_any('slot.weapon.mainhand', 0, 'trenbankai:glock18')"
...
# core
scoreboard players remove @s[scores={glock18=1..}] glock18 1
